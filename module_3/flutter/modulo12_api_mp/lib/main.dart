...
import 'pantalla_paso1_users.dart';   // ← Paso 1
import 'pantalla_paso2.dart';
import 'pantalla_paso2_users.dart';   // ← Paso 2
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/paso1_users', builder: (_, __) => const PantallaPaso1Users()),

    // Paso 2 → reemplaza por PantallaPaso2()
    GoRoute(path: '/paso2', builder: (_, __) => const PantallaPaso2()),

    GoRoute(path: '/paso2_users', builder: (_, __) => const PantallaPaso2Users()),
  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · Préstamos',
        icono: Icons.menu_book,
        color: Colors.blue,
      ),
      _PasoInfo(
        ruta: '/paso1_users',
        titulo: 'Paso 1 - Lectores',
        subtitulo: 'FutureBuilder crudo - Lectores',
        detalle: 'http.get() + FutureBuilder · Lectores de biblioteca',
        icono: Icons.person,
        color: Colors.teal,
      ),
      _PasoInfo(
        ...
        detalle: 'LibroDto.fromJson · catálogo de libros',
        icono: Icons.data_object,
        color: Colors.green,
      ),
      _PasoInfo(
        ruta: '/paso2_users',
        titulo: 'Paso 2 - Lectores',
        subtitulo: 'DTO simple - Lectores',
        detalle: 'LectorDto.fromJson · lista de lectores',
        icono: Icons.person,
        color: Colors.blue,
      ),
      _PasoInfo(
        ...
        detalle: 'LibroDto · toDomain() · API Biblioteca',
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Control de Biblioteca — API REST'),
