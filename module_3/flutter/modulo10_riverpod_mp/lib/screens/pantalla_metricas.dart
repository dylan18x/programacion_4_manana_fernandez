...
class PantallaMetricas extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Estadísticas de biblioteca'),
        actions: [
          IconButton(
...
class _TarjetaMetrica extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final esSSDAlto  = metrica.ssd > 120;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              Icon(Icons.book, color: esCritico ? cs.error : cs.primary, size: 18),
            ...
            _Barra('SSD', metrica.ssd, esSSDAlto),
            const SizedBox(height: 10),
