...
void main() {
  runApp(const ProviderScope(child: AppBiblioteca()));
}

class AppBiblioteca extends StatelessWidget {
...
class _Paso1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Libros prestados')),
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('$count', style: Theme.of(context).textTheme.displayLarge),
            const Text('libros activos'),
          ],
        ),
      ),
