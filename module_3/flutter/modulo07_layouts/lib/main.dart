...
void main() => runApp(MaterialApp(
  ...
  home: switch (paso) {
    ...
    3 => const Scaffold(
      body: Column(
        children: [
          FilaEstado(nombre: 'nginx-proxy',   detalle: '10.0.0.5 · 45ms',          activo: true, message: 'Servicio en línea'),
          Divider(height: 1),
          FilaEstado(nombre: 'db-primary',    detalle: '10.0.0.12 · 8ms',           activo: true, message: 'Base de datos operativa'),
          Divider(height: 1),
          FilaEstado(nombre: 'backup-worker', detalle: '10.0.0.30 · sin respuesta', activo: false, message: 'Worker de backup caído'),
          Divider(height: 1),
          FilaEstado(nombre: 'api-gateway-produccion-region-us-east', detalle: '10.0.0.8 · 12ms', activo: true, message: 'Gateway API en línea'),
          Divider(height: 1),
          FilaEstado(nombre: 'servidor DHCP',   detalle: '10.4.3.2 · 4ms',activo: false, message: 'Servidor DHCP caído'),
        ],
      ),
    ),
    4 => const Scaffold(
