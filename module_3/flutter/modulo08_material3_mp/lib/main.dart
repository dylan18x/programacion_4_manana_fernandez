...
void main() => runApp(const AppBiblioteca());

class AppBiblioteca extends StatefulWidget {
  const AppBiblioteca({super.key});

  @override
  State<AppBiblioteca> createState() => _AppBibliotecaState();
}

class _AppBibliotecaState extends State<AppBiblioteca> {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'ISBN: 978-84-241-1647-7 · Miguel de Cervantes',
