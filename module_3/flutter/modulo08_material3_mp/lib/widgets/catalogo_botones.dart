      ...
      body: ListView(
        ...
        children: [
          ...
          OutlinedButton.icon(
            ...
            label: const Text('Exportar catálogo'),
          ),
          const SizedBox(height: 8),
          TextButton.icon(
            onPressed: () {},
            icon:  const Icon(Icons.open_in_new),
            label: const Text('Ver reglamento de biblioteca'),
          ),
          ...
          FilledButton(
            ...
            onPressed: () {},
            child: const Text('Eliminar registro de libro'),
          ),
          ...
          Row(children: [
            Expanded(
              child: OutlinedButton(onPressed: () {}, child: const Text('Renovar')),
            ),
            const SizedBox(width: 8),
            Expanded(
              child: FilledButton(onPressed: () {}, child: const Text('Devolver')),
            ),
          ]),
        ],
      ),
